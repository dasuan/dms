...
<p>请选择检查日期：</p>
	<input type="text" class="span2 form-control drop_list_add" value="<?php echo date("Y-m-d");?>" id="dp1" name="date" onchange="get_model(this.value)" onselect="get_model(this.value)" required>
